function checkEmail()
{
    ...
    //check if both textboxxes have the same value
     ...
     {
        //error message
        document.getElementById("email-error").innerHTML = "Email must match email below!!!";
        document.getElementById("confirm-error").innerHTML = "Email must match email above!!!";
     }
}
